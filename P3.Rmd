...
Now we start to classify testing data. Since testset is independent with trainset and separate rondomly, we have evidence to say that for any given texts, the model is able to classify them between AI and Human at accuracy 95% confidence interval 0.841-0.888, with out obvious bias on AI or Human.
