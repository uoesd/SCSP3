...
The test results also demonstrate whether the category of LLM being btested oth below 10%. Although Llama and Gemini's results appear slightly lower compared to GPT's performance under the same model, this suggests these two LLMs may be more challenging to distinguish from human writing. Concurrently, the low predictive efficiency of GPT and HUMAN models towards  and Gemini exLlamsignificantly influences classification outcomes. As shown in the charts above, GPT exhibits the lowest probability of being classified as Human, aplains how, under this framework, predictive bias may be influenced concurrently by both the model itself and the type of AI b
eing tested.
