...
This paper will focus on classifying AI texts and Human texts based on the difference on number of 200-frequent-words they use in a text like 'a' and 'the' and total other words. There will be 3 AI: GPT, Gemini and Llama, which will be seen as AI group.
