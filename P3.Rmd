...
Table 2 below shows the LOOCV results of 'KNN' with k=2, 658 of human texts are classified to LLM, which means that the model is bad on recognizing Human texts, most points are classified to LLM. 
