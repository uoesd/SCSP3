...
In the end, as an extra research, we discuss the similarity between three LLM's and also comparing to Human. For example, we train the model by Human and GPT, and test on Gemini. The final results show that both three LLM texts show significant differences from human text. GPT has the most distinctive written style, Gemini and Llama are similar and both closer to human writing.
